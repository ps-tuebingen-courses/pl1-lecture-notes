...
To substitute identiﬁer i in e with expression v, replace all identiﬁers in e that have the name i with the expression v.
...
### Substitution, take 2
To substitute identiﬁer i in e with expression v, replace all identiﬁers in e which are not binding
...
To substitute identiﬁer i in e with expression v, replace all non-binding identiﬁers in e having
...
"To substitute identiﬁer i in e with expression v, replace all free instances of i in e with v."
